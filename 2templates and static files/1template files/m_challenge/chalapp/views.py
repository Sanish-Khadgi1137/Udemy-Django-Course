...
#tags : doing above logic using tags in index.html/ since this html file is inside app(chalapp) we do not need to add template DIR in setting.py but we have to register he app 
...
def chal(request, month2):
    ...
    try:
        ...
        # return HttpResponse(response_data) #this just render challenges.html; displaying "Do work out for 22 min" for all months(click); nothing is passed
    ...
    # except:
    except keyError:#This ensures you only catch the case when the month is not in the dictionary.
